...
<div class="ml-3 mt-4 rounded-2xl flex flex-col content-center py-12">
    ...
    <div class="flex mt-8 gap-10">
        <div class="shadow-md-gray-50 rounded-2xl bg-white w-64 h-20 flex items-center justify-center gap-3">
...
<g>
    ...
    <div class="pt-8 relative w-fit">
        <FlipCard width="920px" height="480px"></FlipCard>
        <button class="leftArrow absolute bg-white flex items-center justify-center w-16 h-16 font-black text-4xl rounded-full border-2 border-gray-600">
            &lt;
        </button>
        <button class="rightArrow absolute bg-white flex items-center justify-center w-16 h-16 font-black text-4xl rounded-full border-2 border-gray-600">
            &gt;
        </button>
    </div>

    <div class="flex justify-end pr-64">
        <div class="flex gap-2">
            ...
            <div>
                ...
                <p class="font-bold">Thomas John</p>
            </div>
        </div>
    ...
    <div class="flex w-full justify-between pr-60">
    ...
    <div class="grid grid-cols-5 gap-2 pr-36 mt-8">
