<template>
    <div class="rounded-xl shadow bg-white card_wrap">
        <p class="text-gray-400 font-normal absolute top-6 right-6">1 of 32</p>
        ...
        <div class="p-9">
            ...
            <div class="grid grid-cols-2 gap-8">
                <button class="bg-white hover:bg-gray-100 text-gray-800 font-semibold py-4 px-6 border border-gray-200 rounded
                                 text-left">
                ...
                <button class="bg-white hover:bg-gray-100 text-gray-800 font-semibold py-4 px-6 border border-gray-200 rounded
                            ...
                            Xin chào, chào bạn.
                            <br>
                            Xin chào, chào bạn.                            Xin chào, chào bạn.
                            <br>
                            Xin chào, chào bạn.
                            </p>
                </button>
