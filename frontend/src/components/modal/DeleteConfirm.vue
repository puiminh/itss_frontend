<template>
    <div class="bg-white rounded-md shadow-md flex flex-col justify-between items-center pt-16 pb-8 px-12">
        <svg class="w-64 h-64" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" height="800px" width="800px" version="1.1" id="Layer_1" viewBox="0 0 512 512" xml:space="preserve">
        ...
        <div class="mt-4">
            <p class="text-2xl font-semibold text-gray-700 text-center">Delete {{ data[`${name}`] }} ? </p>
            <p class="text-md font-semibold text-red-400 text-center mt-2">This action can't undo</p>
        </div>
        
        <div class="flex justify-between mt-12 gap-24">
            <button @click="closeModalMethod"  class="w-full bg-gray-500 hover:bg-gray-700 text-white font-semibold text-md py-3 px-5 rounded focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500" type="button">Cancel</button>
            <button @click="deleteMethod" class="w-full bg-red-500 hover:bg-red-700 text-white font-semibold text-md py-3 px-5 rounded focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500" type="button">Delete</button>
        </div>
    </div>
</template>
