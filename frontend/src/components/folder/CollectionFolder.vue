<template>
    <div class="courseFolderWrap border border-gray-200 px-4 py-3 rounded-md shadow-md bg-white">
    ...
    <script>
import StackImage from '../stackimage/StackImage.vue';
