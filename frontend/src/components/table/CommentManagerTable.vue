              ...
              display: function (row) {
                ...
                return (
                  ...
                  <div class="flex gap-4 ml-2">
                    <a href="/course/${row.course_id}" type="button" data-id="' + row.id + '" class="hover:text-yellow-400">
                    ...
                    <a href="/course/${row.course_id}/edit" data-id="' + row.id + '" class="editButton hover:text-green-500">
                    ...
                    <a href="/course/${row.course_id}/edit" type="button" data-id="' + row.id + '" class="hover:text-red-500">
                      <svg class="w-4 h-4" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="w-6 h-6">
